...
@Log4j2
public class AdsXTeeClientService {
	...
	public AdsXTeeClientService(Environment environment) {
	...
	public <T> ServiceRequest createServiceRequest() throws XRd4JException {
		...
		ProducerMember producerMember = new ProducerMember(instanceIdentifier,
				producerMemberClass,
				producerCode,
				producerSubSystem,
				producerServiceCode,
		...
		ServiceRequest<T> serviceRequest = new ServiceRequest(consumerMember, producerMember, requestId);
